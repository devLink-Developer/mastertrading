...
4. `docs/CALIBRATION_CANONICAL.md`
5. `docs/KNOWN_ISSUES_AND_GUARDRAILS.md`
6. `docs/API_ADMIN_CONFIG.md`
7. This file (`docs/AI_AUDIT_PROJECT_MAP.md`)
...
- This map is intentionally redundant with `docs/LLM_INDEX.md` and `docs/CALIBRATION_CANONICAL.md` so an AI auditor can work from one file.
