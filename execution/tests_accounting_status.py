...
class OperationAccountingStatusTests(TestCase):
    ...
    def test_periodic_report_counts_pending_activity_without_inventing_pnl(self, _context):
        ...
        self.assertIn("Operaciones cerradas: 1", report)
        self.assertIn("Pendientes: 1", report)
        self.assertIn("Acierto: pendiente", report)
        self.assertIn("Cerrado: pendiente de conciliación", report)
        self.assertNotIn("Cerrado: +0.0000", report)
