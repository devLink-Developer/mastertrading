...
def eudy_exploration_risk_integrity_allows(
    *,
    ...
    """Enforce exploratory sizing or its explicitly enabled absolute-risk cap."""
    ...
    if risk_mult > max_risk_mult:
        if absolute_cap_allows and bool(
            getattr(
                settings,
                "EUDY_EXPLORATION_MIN_QTY_ABSOLUTE_CAP_OVERRIDE_ENABLED",
                False,
            )
        ):
            return (
                True,
                "eudy_exploration_absolute_cap_override:"
