...
WEAK_SHORT_TRANSITION_BLOCK_DAILY_REGIMES = _parse_lower_set(
    os.getenv("WEAK_SHORT_TRANSITION_BLOCK_DAILY_REGIMES", "bear_weak")
)
...
DEAD_SESSION_STRONG_TREND_BREAKOUT_MIN_SCORE = float(
    os.getenv("DEAD_SESSION_STRONG_TREND_BREAKOUT_MIN_SCORE", "0.78")
)
DEAD_SESSION_STRONG_TREND_BREAKOUT_MIN_ADX = float(
    os.getenv("DEAD_SESSION_STRONG_TREND_BREAKOUT_MIN_ADX", "30.0")
)
