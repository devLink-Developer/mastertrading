...
ENTRY_VOLUME_FILTER_STRONG_TREND_SOLO_MIN_RATIO = max(
    0.0,
    float(os.getenv("ENTRY_VOLUME_FILTER_STRONG_TREND_SOLO_MIN_RATIO", "0.35")),
)
...
SYMBOL_HEALTH_GUARD_ENABLED = os.getenv("SYMBOL_HEALTH_GUARD_ENABLED", "false").lower() == "true"
SYMBOL_HEALTH_GUARD_LOOKBACK_DAYS = max(
    1,
    int(os.getenv("SYMBOL_HEALTH_GUARD_LOOKBACK_DAYS", "14")),
)
SYMBOL_HEALTH_GUARD_MIN_TRADES = max(
    1,
    int(os.getenv("SYMBOL_HEALTH_GUARD_MIN_TRADES", "8")),
)
SYMBOL_HEALTH_GUARD_MIN_PROFIT_FACTOR = max(
    0.0,
    float(os.getenv("SYMBOL_HEALTH_GUARD_MIN_PROFIT_FACTOR", "0.90")),
)
SYMBOL_HEALTH_GUARD_MIN_EXPECTANCY_USDT = float(
    os.getenv("SYMBOL_HEALTH_GUARD_MIN_EXPECTANCY_USDT", "0.0")
)
...
SYMBOL_SIDE_HEALTH_GUARD_ENABLED = os.getenv(
    "SYMBOL_SIDE_HEALTH_GUARD_ENABLED", "false"
).lower() == "true"
SYMBOL_SIDE_HEALTH_GUARD_LOOKBACK_HOURS = max(
    1,
    int(os.getenv("SYMBOL_SIDE_HEALTH_GUARD_LOOKBACK_HOURS", "48")),
)
SYMBOL_SIDE_HEALTH_GUARD_MIN_TRADES = max(
    1,
    int(os.getenv("SYMBOL_SIDE_HEALTH_GUARD_MIN_TRADES", "3")),
)
SYMBOL_SIDE_HEALTH_GUARD_MIN_PROFIT_FACTOR = max(
    0.0,
    float(os.getenv("SYMBOL_SIDE_HEALTH_GUARD_MIN_PROFIT_FACTOR", "0.70")),
)
SYMBOL_SIDE_HEALTH_GUARD_MIN_EXPECTANCY_PCT = float(
    os.getenv("SYMBOL_SIDE_HEALTH_GUARD_MIN_EXPECTANCY_PCT", "0.0")
)
SYMBOL_SIDE_HEALTH_GUARD_EXEMPT_SYMBOLS = _parse_lower_set(
    os.getenv("SYMBOL_SIDE_HEALTH_GUARD_EXEMPT_SYMBOLS", "")
)
SYMBOL_SIDE_HEALTH_GUARD_RESET_AT = os.getenv(
    "SYMBOL_SIDE_HEALTH_GUARD_RESET_AT", ""
).strip()
ENTRY_QUALITY_PROFILE_ENABLED = os.getenv(
    "ENTRY_QUALITY_PROFILE_ENABLED", "false"
).lower() == "true"
ENTRY_QUALITY_PROFILE_ALLOWED_SYMBOLS = _parse_lower_set(
    os.getenv("ENTRY_QUALITY_PROFILE_ALLOWED_SYMBOLS", "")
)
ENTRY_QUALITY_PROFILE_ALLOWED_SESSIONS = _parse_lower_set(
    os.getenv("ENTRY_QUALITY_PROFILE_ALLOWED_SESSIONS", "")
)
ENTRY_QUALITY_PROFILE_ALLOWED_MODULE_SETS = _parse_lower_set(
    os.getenv("ENTRY_QUALITY_PROFILE_ALLOWED_MODULE_SETS", "")
)
ENTRY_QUALITY_PROFILE_MIN_NET_SCORE = max(
    0.0,
...
EUDY_EXPLORATION_MIN_QTY_ABSOLUTE_CAP_OVERRIDE_ENABLED = os.getenv(
    "EUDY_EXPLORATION_MIN_QTY_ABSOLUTE_CAP_OVERRIDE_ENABLED", "false"
).lower() == "true"
...
SYMBOL_HEAT_GUARD_LOOKBACK_DAYS = int(os.getenv("SYMBOL_HEAT_GUARD_LOOKBACK_DAYS", "30"))
...
SYMBOL_HEAT_GUARD_MIN_PROFIT_FACTOR = float(os.getenv("SYMBOL_HEAT_GUARD_MIN_PROFIT_FACTOR", "0.0"))
SYMBOL_HEAT_GUARD_MIN_EXPECTANCY_PCT = float(os.getenv("SYMBOL_HEAT_GUARD_MIN_EXPECTANCY_PCT", "-1.0"))
...
SYMBOL_HEAT_GUARD_RESET_AT = os.getenv("SYMBOL_HEAT_GUARD_RESET_AT", "").strip()
...
MODULE_TREND_KALMAN_BOOST = max(
    0.0,
    min(0.25, float(os.getenv("MODULE_TREND_KALMAN_BOOST", "0.05"))),
)
...
ALLOCATOR_STRONG_TREND_SOLO_ALLOWED_SYMBOLS = _parse_symbol_set(
    os.getenv("ALLOCATOR_STRONG_TREND_SOLO_ALLOWED_SYMBOLS", "")
)
ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ENVELOPE_ENABLED = (
    os.getenv("ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ENVELOPE_ENABLED", "false").lower()
    == "true"
)
ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ALLOWED_SYMBOLS = _parse_symbol_set(
    os.getenv("ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ALLOWED_SYMBOLS", "")
)
ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ALLOWED_SESSIONS = _parse_session_set(
    os.getenv("ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ALLOWED_SESSIONS", "")
)
ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ADX_MIN = max(
    0.0, float(os.getenv("ALLOCATOR_STRONG_TREND_SOLO_SAFETY_ADX_MIN", "0"))
)
ALLOCATOR_STRONG_TREND_SOLO_SAFETY_CONFIDENCE_MIN = max(
    0.0,
    min(
        1.0,
        float(os.getenv("ALLOCATOR_STRONG_TREND_SOLO_SAFETY_CONFIDENCE_MIN", "0")),
    ),
)
ALLOCATOR_STRONG_TREND_SOLO_SAFETY_VOLUME_MIN_RATIO = max(
    0.0,
    float(os.getenv("ALLOCATOR_STRONG_TREND_SOLO_SAFETY_VOLUME_MIN_RATIO", "0")),
)
ALLOCATOR_PER_INSTRUMENT_RISK_ENABLED = (
    os.getenv("ALLOCATOR_PER_INSTRUMENT_RISK_ENABLED", "false").lower() == "true"
)
...
EUDY_ATOMIC_DAILY_TRADE_CAP_ENABLED = (
    os.getenv("EUDY_ATOMIC_DAILY_TRADE_CAP_ENABLED", "false").lower() == "true"
)
EUDY_ATOMIC_DAILY_TRADE_CAP_FAIL_CLOSED = (
    os.getenv("EUDY_ATOMIC_DAILY_TRADE_CAP_FAIL_CLOSED", "true").lower() == "true"
)
ALLOCATOR_RANGE_REVERSION_SOLO_ENABLED = (
    os.getenv("ALLOCATOR_RANGE_REVERSION_SOLO_ENABLED", "true").lower() == "true"
)
ALLOCATOR_RANGE_REVERSION_SOLO_MODULES = _parse_lower_set(
    os.getenv("ALLOCATOR_RANGE_REVERSION_SOLO_MODULES", "grid,meanrev")
)
ALLOCATOR_RANGE_REVERSION_SOLO_MIN_CONFIDENCE = max(
    0.0,
    min(1.0, float(os.getenv("ALLOCATOR_RANGE_REVERSION_SOLO_MIN_CONFIDENCE", "0.75"))),
)
ALLOCATOR_RANGE_REVERSION_SOLO_WEIGHT_FLOOR = max(
    0.0,
    min(1.0, float(os.getenv("ALLOCATOR_RANGE_REVERSION_SOLO_WEIGHT_FLOOR", "0.24"))),
)
